...
<head>
    ...
    <title>Por Diversion XD</title>

    <!-- Bootstrap core CSS -->
    <link href="/PorDiversion/css/bootstrap.css" rel="stylesheet">

    <!-- Custom CSS for the 'Thumbnail Gallery' Template -->
    <link href="/PorDiversion/css/2-col-portfolio.css" rel="stylesheet">
</head>
...
<body>
    ...
    <!-- JavaScript -->
    <script src="/PorDiversion/js/jquery.js"></script>
    <script src="/PorDiversion/js/bootstrap.js"></script>
